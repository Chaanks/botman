...
class ArtifactsClient:
    ...
    async def get_bank_items(self, item_code: Optional[str] = None, page: int = 1, size: int = 50) -> List[BankItem]:
        """Fetch items in bank"""
    ...
    async def get_ge_orders(self, code: Optional[str] = None, page: int = 1, size: int = 50) -> List[GEOrder]:
    ...
    async def get_ge_history(self, order_id: Optional[str] = None, code: Optional[str] = None, 
                            page: int = 1, size: int = 50) -> List[GETransaction]:
    ...
    async def get_logs(self, name: Optional[str] = None, page: int = 1, size: int = 50) -> LogPage:
    ...
    async def change_password(self, current_password: str, new_password: str) -> dict:
        ...
        return await self._request("POST", "/my/change_password", {
    ...
    async def equip(self, item_code: str, slot: str, quantity: int = 1, name: Optional[str] = None) -> EquipResult:
        """Equip an item"""
        name = name or self.character_name
        data = await self._request("POST", f"/my/{name}/action/equip", {
            "code": item_code,
            "slot": slot,
            "quantity": quantity
        })
    ...
    async def unequip(self, slot: str, quantity: int = 1, name: Optional[str] = None) -> EquipResult:
        """Unequip an item"""
        name = name or self.character_name
        data = await self._request("POST", f"/my/{name}/action/unequip", {
            "slot": slot,
            "quantity": quantity
        })
        return EquipResult.model_validate(data)
    
    async def use_item(self, item_code: str, quantity: int = 1, name: Optional[str] = None) -> ActionResult:
        """Use a consumable item"""
        name = name or self.character_name
        data = await self._request("POST", f"/my/{name}/action/use", {
            "code": item_code,
            "quantity": quantity
        })
        return ActionResult.model_validate(data)
    
    async def fight(self, participants: Optional[List[str]] = None, name: Optional[str] = None) -> FightResult:
    ...
    async def craft(self, item_code: str, quantity: int = 1, name: Optional[str] = None) -> CraftResult:
        """Craft an item at a workshop"""
        name = name or self.character_name
        data = await self._request("POST", f"/my/{name}/action/crafting", {
            "code": item_code,
            "quantity": quantity
        })
    ...
    async def deposit_gold(self, quantity: int, name: Optional[str] = None) -> BankResult:
        """Deposit gold in bank"""
        name = name or self.character_name
        data = await self._request("POST", f"/my/{name}/action/bank/deposit/gold", {
            "quantity": quantity
        })
        return BankResult.model_validate(data)
    
    async def deposit_item(self, items: List[dict], name: Optional[str] = None) -> BankResult:
        """Deposit items in bank. items = [{"code": "item_code", "quantity": 1}, ...]"""
        name = name or self.character_name
        data = await self._request("POST", f"/my/{name}/action/bank/deposit/item", items)
        return BankResult.model_validate(data)
    
    async def withdraw_gold(self, quantity: int, name: Optional[str] = None) -> BankResult:
        """Withdraw gold from bank"""
        name = name or self.character_name
        data = await self._request("POST", f"/my/{name}/action/bank/withdraw/gold", {
            "quantity": quantity
        })
        return BankResult.model_validate(data)
    
    async def withdraw_item(self, items: List[dict], name: Optional[str] = None) -> BankResult:
        """Withdraw items from bank. items = [{"code": "item_code", "quantity": 1}, ...]"""
        name = name or self.character_name
        data = await self._request("POST", f"/my/{name}/action/bank/withdraw/item", items)
        return BankResult.model_validate(data)
    ...
    async def npc_buy(self, item_code: str, quantity: int = 1, name: Optional[str] = None) -> TradeResult:
        """Buy an item from NPC"""
        name = name or self.character_name
        data = await self._request("POST", f"/my/{name}/action/npc/buy", {
            "code": item_code,
            "quantity": quantity
        })
        return TradeResult.model_validate(data)
    
    async def npc_sell(self, item_code: str, quantity: int = 1, name: Optional[str] = None) -> TradeResult:
        """Sell an item to NPC"""
        name = name or self.character_name
        data = await self._request("POST", f"/my/{name}/action/npc/sell", {
            "code": item_code,
            "quantity": quantity
        })
        return TradeResult.model_validate(data)
    ...
    async def ge_buy(self, order_id: str, quantity: int, name: Optional[str] = None) -> GEResult:
        """Buy item from Grand Exchange"""
        name = name or self.character_name
        data = await self._request("POST", f"/my/{name}/action/grandexchange/buy", {
            "id": order_id,
            "quantity": quantity
        })
        return GEResult.model_validate(data)
    
    async def ge_sell(self, item_code: str, quantity: int, price: int, name: Optional[str] = None) -> GEResult:
        """Create sell order at Grand Exchange (3% listing tax)"""
        name = name or self.character_name
        data = await self._request("POST", f"/my/{name}/action/grandexchange/sell", {
            "code": item_code,
            "quantity": quantity,
            "price": price
        })
    ...
    async def ge_cancel(self, order_id: str, name: Optional[str] = None) -> GEResult:
        ...
        name = name or self.character_name
        data = await self._request("POST", f"/my/{name}/action/grandexchange/cancel", {
            "id": order_id
        })
        return GEResult.model_validate(data)
    ...
    async def task_trade(self, item_code: str, quantity: int, name: Optional[str] = None) -> ActionResult:
        """Trade items with Tasks Master"""
        name = name or self.character_name
        data = await self._request("POST", f"/my/{name}/action/task/trade", {
            "code": item_code,
            "quantity": quantity
        })
        return ActionResult.model_validate(data)
    ...
    async def recycle(self, item_code: str, quantity: int = 1, name: Optional[str] = None) -> RecycleResult:
        """Recycle an item at workshop"""
        name = name or self.character_name
        data = await self._request("POST", f"/my/{name}/action/recycling", {
            "code": item_code,
            "quantity": quantity
        })
        return RecycleResult.model_validate(data)
    
    async def give_gold(self, recipient: str, quantity: int, name: Optional[str] = None) -> ActionResult:
        """Give gold to another character on same map"""
        name = name or self.character_name
        data = await self._request("POST", f"/my/{name}/action/give/gold", {
            "name": recipient,
            "quantity": quantity
        })
        return ActionResult.model_validate(data)
    
    async def give_item(self, recipient: str, items: List[dict], name: Optional[str] = None) -> ActionResult:
        """Give items to another character. items = [{"code": "item", "quantity": 1}, ...]"""
        name = name or self.character_name
        data = await self._request("POST", f"/my/{name}/action/give/item", {
            "name": recipient,
            "items": items
        })
        return ActionResult.model_validate(data)
    
    async def delete_item(self, item_code: str, quantity: int, name: Optional[str] = None) -> ActionResult:
        """Delete item from inventory"""
        name = name or self.character_name
        data = await self._request("POST", f"/my/{name}/action/delete", {
            "code": item_code,
            "quantity": quantity
        })
        return ActionResult.model_validate(data)
    ...
    async def change_skin(self, skin: str, name: Optional[str] = None) -> ActionResult:
        ...
        name = name or self.character_name
        data = await self._request("POST", f"/my/{name}/action/change_skin", {
            "skin": skin
        })
        return ActionResult.model_validate(data)
    ...
    # ===== Achievements =====
    async def get_achievements(self, achievement_type: Optional[str] = None, 
                              page: int = 1, size: int = 50) -> AchievementPage:
    ...
    async def get_account_achievements(self, account: str, achievement_type: Optional[str] = None,
                                      completed: Optional[bool] = None, page: int = 1, size: int = 50) -> AccountAchievementPage:
    ...
    async def create_character(self, name: str, skin: str = "men1") -> Character:
        ...
        data = await self._request("POST", "/characters/create", {
            "name": name,
            "skin": skin
        })
    ...
    async def get_active_characters(self, page: int = 1, size: int = 50) -> ActiveCharacterPage:
    ...
    async def get_events(self, event_type: Optional[str] = None, 
                        page: int = 1, size: int = 50) -> EventPage:
        """Get all events"""
        params = [f"page={page}", f"size={size}"]
        if event_type:
    ...
    # ===== Grand Exchange =====
    async def get_ge_item_history(self, code: str, seller: Optional[str] = None, 
                                  buyer: Optional[str] = None, page: int = 1, size: int = 50) -> GEOrderHistoryPage:
    ...
    async def get_all_ge_orders(self, code: Optional[str] = None, seller: Optional[str] = None,
                               page: int = 1, size: int = 50) -> GEOrderPage:
    ...
    # ===== Items =====
    async def get_items(self, name: Optional[str] = None, min_level: Optional[int] = None,
                       max_level: Optional[int] = None, item_type: Optional[str] = None,
                       craft_skill: Optional[str] = None, craft_material: Optional[str] = None,
                       page: int = 1, size: int = 50) -> ItemPage:
    ...
    # ===== Leaderboards =====
    async def get_characters_leaderboard(self, sort: Optional[str] = None, name: Optional[str] = None,
                                        page: int = 1, size: int = 50) -> CharacterLeaderboardPage:
    ...
    async def get_accounts_leaderboard(self, sort: Optional[str] = None, name: Optional[str] = None,
                                      page: int = 1, size: int = 50) -> AccountLeaderboardPage:
    ...
    # ===== Maps =====
    async def get_maps(self, layer: Optional[str] = None, content_type: Optional[str] = None,
                      content_code: Optional[str] = None, hide_blocked_maps: bool = False,
                      page: int = 1, size: int = 50) -> MapPage:
    ...
    async def get_layer_maps(self, layer: str, content_type: Optional[str] = None,
                            content_code: Optional[str] = None, hide_blocked_maps: bool = False,
                            page: int = 1, size: int = 50) -> MapPage:
    ...
    # ===== Monsters =====
    async def get_monsters(self, name: Optional[str] = None, min_level: Optional[int] = None,
                          max_level: Optional[int] = None, drop: Optional[str] = None,
                          page: int = 1, size: int = 50) -> MonsterPage:
    ...
    # ===== NPCs =====
    async def get_npcs(self, name: Optional[str] = None, npc_type: Optional[str] = None,
                      page: int = 1, size: int = 50) -> NPCPage:
    ...
    async def get_npc_items(self, code: str, page: int = 1, size: int = 50) -> NPCItemPage:
    ...
    async def get_all_npc_items(self, code: Optional[str] = None, npc: Optional[str] = None,
                               currency: Optional[str] = None, page: int = 1, size: int = 50) -> NPCItemPage:
    ...
    # ===== Resources =====
    async def get_resources(self, min_level: Optional[int] = None, max_level: Optional[int] = None,
                           skill: Optional[str] = None, drop: Optional[str] = None,
                           page: int = 1, size: int = 50) -> ResourcePage:
    ...
    # ===== Tasks =====
    async def get_all_tasks(self, min_level: Optional[int] = None, max_level: Optional[int] = None,
                           skill: Optional[str] = None, task_type: Optional[str] = None,
                           page: int = 1, size: int = 50) -> TaskFullPage:
    ...
    async def get_tasks_rewards(self, page: int = 1, size: int = 50) -> TaskRewardDropPage:
    ...
    # ===== Simulation =====
    async def simulate_fight(self, characters: List[FakeCharacter], monster: str, 
                            iterations: int = 10) -> CombatSimulation:
        ...
        """
        data = await self._request("POST", "/simulation/fight_simulation", {
